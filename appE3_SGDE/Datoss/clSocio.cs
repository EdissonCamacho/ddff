    ...
    class clSocio
    {
        ...
        public List<clSocio> mtdConsultaSocio()
        {
            ...
            for (int i = 0; i < tblresultado.Rows.Count; i++)
            {
                ...
                objSocio.Apellido = tblresultado.Rows[i]["Apellido"].ToString();
        ...
        {
            string consulta = "insert into Socio (Socio,Nombre,Apellido,Direccion,Telefono,Email,Disponibilidad,Clave) values ('" + idSocio + "','" + Nombre + "','" + Apellido + "','" + Direccion + "','" + Telefono + "','" + Email + "','" + Disponibilidad + "','" + Clave + ";)";
            objConexion = new clConexion();
        ...
        {
            string consulta = "update Socio set idSocio='" + idSocio + "',Nombre = '" + Nombre + "', Apellido ='" + Direccion + "' where idSocio='" + idSocio + "'";
            objConexion = new clConexion();
